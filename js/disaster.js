    ...
    phases: [
      {
        ...
        alert: { level: 'warn', msg: '瓦斯浓度持续上升，检查通风系统' },
        fx: null,
      },
      {
        name: '瓦斯急剧积聚',
    ...
    phases: [
      {
        ...
        alert: { level: 'warn', msg: '检测到微震信号，煤壁有异常声响' },
        fx: null,
      },
      {
        name: '突出发生',
    ...
    phases: [
      {
        ...
        alert: { level: 'warn', msg: '液压支架压力持续升高，顶板离层监测异常' },
        fx: null,
      },
      {
        name: '局部冒落',
        ...
        alert: { level: 'warn', msg: '工作面局部掉渣，有冒顶迹象' },
        fx: 'smallFall',
      },
      {
        name: '大面积垮落',
      ...
      },
      {
        ...
        alert: { level: 'warn', msg: '灾后恢复中，监测余震和二次冒落' },
        fx: 'aftermath',
      },
    ],
  },
    ...
    phases: [
      {
        ...
        alert: { level: 'warn', msg: '煤壁渗水增多，有"出汗"现象，水质异常' },
        fx: 'seepage',
      },
      {
        name: '突水发生',
    ...
    phases: [
      {
        ...
        alert: { level: 'warn', msg: '采空区CO浓度持续升高，温度异常上升' },
        fx: 'smoke',
      },
      {
        name: '加速升温',
...
Object.assign(SCENARIOS, {
  ...
  roofPressureRise: {
    ...
    phases: [{
      ...
      alert: { level: 'warn', msg: '顶板压力持续升高，建议核查支护状态并降低推进速度' },
      fx: 'roofRiskWatch',
    }],
  },
  roofSeparationAlarm: {
    ...
    phases: [{
      ...
      alert: { level: 'warn', msg: '顶板离层量异常增大，需复核锚杆锚索受力与围岩变形' },
      fx: 'roofRiskWarn',
    }],
  },
  supportResistanceAlarm: {
    ...
    phases: [{
      ...
      alert: { level: 'warn', msg: '液压支架工作阻力异常，建议联动采煤机降速或停机检查' },
      fx: 'supportOverload',
    }],
  },
  roofFallWarning: {
